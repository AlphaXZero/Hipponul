...
def half_float_to_dec(binary_repr):
    """take a reporesention of a half-float as a list of ints and returns his value"""
...
if __name__ == "__main__":
    print(half_float(120.5))
    print(half_float_to_dec(half_float(120.5)))
